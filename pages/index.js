      ...
      <main className=" bg-white px-10 dark:bg-gray-900 md:px-20 lg:px-40">
        <section className="min-h-screen">
          <nav className="py-10 mb-12 flex justify-between dark:text-white">
            <h1 className="font-burtons text-xl">sirmur.com</h1>
          ...
          <div className="text-center p-10 py-10">
            ...
            <p className="text-md py-5 leading-8 text-gray-800 dark:text-gray-200 max-w-xl mx-auto md:text-xl">
              Freelancer providing services for programming and 2D/3D design content
              needs. Email me down below and let's get to work!
            </p>
        ...
        <section>
          ...
          <div className="lg:flex gap-10">
            ...
            <div className="text-center shadow-lg p-10 rounded-xl my-10 dark:bg-white flex-1">
              ...
              <p className="text-gray-800 py-1">Bash (Terminal)</p>
              <p className="text-gray-800 py-1">Github</p>
              <p className="text-gray-800 py-1">Notes</p>
            </div>
            <div className="text-center shadow-lg p-10 rounded-xl my-10 dark:bg-white flex-1">
              <Image src={consulting} width={100} height={100} alt="" />
              <h3 className="text-lg font-medium pt-8 pb-2 ">Software Proficiencies</h3>
              <p className="py-2">
                Are you interested in my services? Here are the skills that I have years of practice with.
              </p>
